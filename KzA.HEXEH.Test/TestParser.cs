...
namespace KzA.HEXEH.Test
{
    public class TestParser(ITestOutputHelper output) : TestBase(output)
    {
        ...
        [Fact]
        public void TestLengthedObjectArray()
        {

            var data = new byte[] {  };
            var parser = new LengthedObjectArrayParser();
            var stringParserOpt = new Dictionary<string, object>()
            { {"Encoding", Encoding.Unicode } };
            parser.SetOptions(new Dictionary<string, object>()
            {
        ...
        [Fact]
        public void TestCountedFixedObjectArray()
        {
            var data = new byte[] { 0x04,
                                    ...
                                    0x0A, 0x7A, 0x00, 0x79,
                                    0xBB, 0x20, 0x00, 0x66};
            var parser = new CountedFixedObjectArrayParser();
            parser.SetOptions(new Dictionary<string, object>()
            {
                { "LenOfCount", 1 },
                { "LenOfObject", 4 },
